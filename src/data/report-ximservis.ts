...
export const workPlan = [
  ...
  'Разработка нового фида по перечню, который прислал клиент',
  'Сбор дополнительной статистики по обращениям из Яндекс Директа: поисковые запросы, регионы и устройства пользователей',
  'Продолжение мониторинга доли B2B- и B2C-обращений с внесением корректировок в рекламу при необходимости',
];
