...
// ── Лучшие и худшие креативы по итогам июня 2026 ──
export const creativeInsights = {
  best: [
    { title: 'ПСК 17,8%-18,6%. ЖК «Новая Тверь» — ипотека 6% для семей', text: 'Лидер по конверсиям — 9 лидов при CPA 7 135 ₽, лучший баланс объёма и цены.' },
    { title: 'Современные квартиры в Твери с комфортным платежом', text: 'Самый низкий CPA среди всех — 2 150 ₽ и CR 2,08%, но пока малый объём показов.' },
  ],
  worst: [
    { title: 'Квартиры комфорт-класса с выгодными условиями по ипотеке', text: '14 183 ₽ расхода и 108 кликов — 0 конверсий, самый дорогой неэффективный креатив.' },
    { title: 'ПСК 17,8%-18,6%. Подберите квартиру с ипотекой под 6%!', text: '5 563 ₽ расхода и 60 кликов без единой конверсии.' },
  ],
};
