...
export const AGENCY = {
  name: 'Агентство',
  logo: 'https://cdn.poehali.dev/projects/3be3231f-d46e-4b4e-8c41-7aaa84ef4ad6/files/72379477-9e73-441f-981e-1d3979225bb1.jpg',
};

export const aboutLinks = [
  { icon: 'CalendarRange', label: 'Понедельная статистика', desc: 'Расход, заявки и стоимость лида по неделям месяца.', href: '', cta: '' },
  { icon: 'TrendingUp', label: 'Воронка окупаемости', desc: 'Путь от лида до сделки и юнит-экономика проекта.', href: '', cta: '' },
  { icon: 'Globe', label: 'Сайт', desc: 'Посадочная страница, на которую ведёт реклама.', href: CLIENT.site, cta: 'site.ru' },
];
...
// ── Кампании ──
export const campaigns = ['Поиск/тестовый пример'];

// ── Кампания → группа: полная статистика (топ-10 по расходу) ──
export const byGroupFull = [
  { campaign: campaigns[0], name: 'Группа 1', cost: 130000, impressions: 3600, clicks: 155, ctr: 4.31, cpc: 838.71, avgTraffic: 86, avgPos: 3.1, bounce: 32, conv: 16, cr: 10.32, cpa: 8125 },
  { campaign: campaigns[0], name: 'Группа 2', cost: 34500, impressions: 850, clicks: 68, ctr: 8.00, cpc: 507.35, avgTraffic: 90, avgPos: 2.3, bounce: 35, conv: 3, cr: 4.41, cpa: 11500 },
  { campaign: campaigns[0], name: 'Группа 3', cost: 9500, impressions: 210, clicks: 11, ctr: 5.24, cpc: 863.64, avgTraffic: 80, avgPos: 2.6, bounce: 27, conv: 1, cr: 9.09, cpa: 9500 },
  { campaign: campaigns[0], name: 'Группа 4', cost: 5500, impressions: 380, clicks: 6, ctr: 1.58, cpc: 916.67, avgTraffic: 88, avgPos: 4.8, bounce: 17, conv: 1, cr: 16.67, cpa: 5500 },
  { campaign: campaigns[0], name: 'Группа 5', cost: 5950, impressions: 210, clicks: 4, ctr: 1.90, cpc: 1487.50, avgTraffic: 87, avgPos: 4.6, bounce: 0, conv: 1, cr: 25.00, cpa: 5950 },
  { campaign: campaigns[0], name: 'Группа 6', cost: 3600, impressions: 40, clicks: 5, ctr: 12.50, cpc: 720.00, avgTraffic: 88, avgPos: 2.7, bounce: 0, conv: 1, cr: 20.00, cpa: 3600 },
  { campaign: campaigns[0], name: 'Группа 7', cost: 3400, impressions: 40, clicks: 3, ctr: 7.50, cpc: 1133.33, avgTraffic: 65, avgPos: 3.4, bounce: 33, conv: 0, cr: 0, cpa: null },
  { campaign: campaigns[0], name: 'Группа 8', cost: 3000, impressions: 90, clicks: 4, ctr: 4.44, cpc: 750.00, avgTraffic: 95, avgPos: 2.5, bounce: 25, conv: 1, cr: 25.00, cpa: 3000 },
  { campaign: campaigns[0], name: 'Группа 9', cost: 2468, impressions: 250, clicks: 1, ctr: 0.40, cpc: 2468.00, avgTraffic: 85, avgPos: 4.8, bounce: 0, conv: 1, cr: 100.00, cpa: 2468 },
  { campaign: campaigns[0], name: 'Группа 10', cost: 1350, impressions: 240, clicks: 2, ctr: 0.83, cpc: 675.00, avgTraffic: 90, avgPos: 4.4, bounce: 50, conv: 1, cr: 50.00, cpa: 1350 },
];
...
export const adsFull = [
  { campaign: campaigns[0], group: 'Группа 1', title: 'Заголовок объявления 1', text: 'Текст описания объявления 1', cost: 59652, impressions: 2400, clicks: 94, ctr: 3.92, cpc: 634.60, avgTraffic: 85, avgPos: 3.2, bounce: 35, conv: 9, cr: 9.57, cpa: 6628 },
  { campaign: campaigns[0], group: 'Группа 2', title: 'Заголовок объявления 2', text: 'Текст описания объявления 2', cost: 13740, impressions: 520, clicks: 27, ctr: 5.19, cpc: 508.89, avgTraffic: 88, avgPos: 2.4, bounce: 30, conv: 2, cr: 7.41, cpa: 6870 },
  { campaign: campaigns[0], group: 'Группа 3', title: 'Заголовок объявления 3', text: 'Текст описания объявления 3', cost: 9500, impressions: 210, clicks: 11, ctr: 5.24, cpc: 863.64, avgTraffic: 80, avgPos: 2.6, bounce: 27, conv: 1, cr: 9.09, cpa: 9500 },
  { campaign: campaigns[0], group: 'Группа 4', title: 'Заголовок объявления 4', text: 'Текст описания объявления 4', cost: 5500, impressions: 380, clicks: 6, ctr: 1.58, cpc: 916.67, avgTraffic: 88, avgPos: 4.8, bounce: 17, conv: 1, cr: 16.67, cpa: 5500 },
  { campaign: campaigns[0], group: 'Группа 5', title: 'Заголовок объявления 5', text: 'Текст описания объявления 5', cost: 5950, impressions: 210, clicks: 4, ctr: 1.90, cpc: 1487.50, avgTraffic: 87, avgPos: 4.6, bounce: 0, conv: 1, cr: 25.00, cpa: 5950 },
  { campaign: campaigns[0], group: 'Группа 6', title: 'Заголовок объявления 6', text: 'Текст описания объявления 6', cost: 3600, impressions: 40, clicks: 5, ctr: 12.50, cpc: 720.00, avgTraffic: 88, avgPos: 2.7, bounce: 0, conv: 1, cr: 20.00, cpa: 3600 },
  { campaign: campaigns[0], group: 'Группа 7', title: 'Заголовок объявления 7', text: 'Текст описания объявления 7', cost: 3400, impressions: 40, clicks: 3, ctr: 7.50, cpc: 1133.33, avgTraffic: 65, avgPos: 3.4, bounce: 33, conv: 0, cr: 0, cpa: null },
  { campaign: campaigns[0], group: 'Группа 8', title: 'Заголовок объявления 8', text: 'Текст описания объявления 8', cost: 3000, impressions: 90, clicks: 4, ctr: 4.44, cpc: 750.00, avgTraffic: 95, avgPos: 2.5, bounce: 25, conv: 1, cr: 25.00, cpa: 3000 },
  { campaign: campaigns[0], group: 'Группа 9', title: 'Заголовок объявления 9', text: 'Текст описания объявления 9', cost: 2468, impressions: 250, clicks: 1, ctr: 0.40, cpc: 2468.00, avgTraffic: 85, avgPos: 4.8, bounce: 0, conv: 1, cr: 100.00, cpa: 2468 },
  { campaign: campaigns[0], group: 'Группа 10', title: 'Заголовок объявления 10', text: 'Текст описания объявления 10', cost: 1350, impressions: 240, clicks: 2, ctr: 0.83, cpc: 675.00, avgTraffic: 90, avgPos: 4.4, bounce: 50, conv: 1, cr: 50.00, cpa: 1350 },
];
...
// ── Допродажа каналов: не используется на демо-странице ──
export const upsellChannels: never[] = [];
export const upsellDiscountPerChannel = 10;
...
export const breakdownInsights = [
  {
    ...
    items: [
      { title: 'Устройства', text: 'Десктоп даёт почти весь объём конверсий; смартфоны и планшеты тратят бюджет почти без заявок.', hint: 'Усилить понижающие корректировки на mobile до -50%' },
      { title: 'Группы объявлений', text: '«Группа 1» — главный драйвер лидов, но CPA выше среднего.', hint: 'Перераспределить часть бюджета в группы с CPA ниже среднего' },
    ],
  },
  {
    level: 'mid', label: 'Средний приоритет', icon: 'AlertCircle', color: NEON.amber,
    items: [
      { title: 'Пол и возраст', text: 'Ядро конверсий — мужчины и сегмент 45-54 года, сегмент 18-24 даёт 0 конверсий.', hint: 'Повысить ставки на 45-54, срезать 18-24' },
      { title: 'Условие показа', text: 'Ключевые фразы конверсионнее автотаргетинга по CPA.', hint: 'Держать автотаргет на контроле, отсекать нерелевантные запросы' },
    ],
  },
  {
    ...
    items: [
      ...
      { title: 'Объявления', text: 'Лучший оффер — «Заголовок объявления 1», остальные заметно слабее по CTR.', hint: 'Добавить УТП с ценой/сроком и быстрые ссылки в топ-объявления' },
    ],
  },
];
