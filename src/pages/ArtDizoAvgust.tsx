        ...
        <Section id="trends" num="04" title="Тренды с начала работ" icon="ChartLine" sub="Проект в работе с июля 2026 — динамика по месяцам">
          ...
          <Card className="mt-6 border-primary/30">
            ...
            <p className="text-sm leading-relaxed text-foreground/90">
              Август стал сильным месяцем: рекламный бюджет вырос до <b>129 249 ₽</b>, а число уникальных лидов
              увеличилось до <b>117</b> — почти в 2,5 раза больше июля. При этом доля чистых заявок поднялась
              до <b>95,73%</b>, а их стоимость снизилась до <b>1 154 ₽</b>. Количество квалифицированных лидов
              выросло до <b>73</b> при стоимости <b>1 771 ₽</b> — заметно ниже плановой. План по всем ключевым
              показателям перевыполнен, что подтверждает эффективность найденных рекламных связок и их успешное
              масштабирование.
            </p>
          </Card>
        </Section>
