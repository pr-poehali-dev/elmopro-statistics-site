        ...
        <Section id="trends" num="04" title="Тренды с начала работ" icon="ChartLine" sub="Проект в работе с июля 2026 — динамика по месяцам">
          ...
          <Card className="mt-6 border-primary/30">
            ...
            <p className="text-sm leading-relaxed text-foreground/90">
              В августе продолжали оптимизировать и разгонять рекламные кампании. Удалось получить <b>112 чистых
              лидов</b> по <b>1154 ₽</b> и <b>73 квалифицированных лида</b> по <b>1771 ₽</b>. Это довольно хороший
              результат на этот месяц. На данный момент некоторые рекламные кампании остановлены и сокращен
              бюджет на рекламу в связи с большим количеством лидов.
            </p>
          </Card>
        </Section>
