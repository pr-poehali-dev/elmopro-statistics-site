...
} from '@/data/report-art-dizo-avgust';
  ...
  return (
    <div ref={reportRef} className="min-h-screen bg-background text-foreground">
      ...
      <div className="container mx-auto space-y-16 px-6 py-12">
        ...
        {/* 2. ПЛАН / ФАКТ */}
        <Section id="planfact" num="02" title="Сравнение план / факт" icon="Target" sub="Динамика по ключевым показателям за август 2026">
          <Card>
        ...
        <Section id="trends" num="04" title="Тренды с начала работ" icon="ChartLine" sub="Проект в работе с июля 2026 — динамика по месяцам">
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <Card>
              <ChartTitle title="Уникальные лиды, ед." sub="Июль — Август"
            ...
            <Card>
              <ChartTitle title="Стоимость уникального лида, ₽" sub="Июль — Август"
            ...
            <Card>
              <ChartTitle title="Чистые лиды, ед." sub="Июль — Август"
            ...
            <Card>
              <ChartTitle title="Стоимость чистого лида, ₽" sub="Июль — Август"
          ...
          <Card className="mt-6 border-primary/30">
            ...
            <p className="text-sm leading-relaxed text-foreground/90">
              В августе продолжали оптимизировать и разгонять рекламные кампании. По итогам месяца удалось
              получить <b>112 чистых лидов</b> по <b>1 154 ₽</b> и <b>73 квалифицированных лида</b> по
              <b> 1 771 ₽</b>. Это довольно хороший результат на этот месяц.
              <br /><br />
              На данный момент некоторые рекламные кампании остановлены, бюджет на рекламу сокращен, так как
              были трудности с обраткой такого количества заявок. Объем лидов удалось снизить без потери
              качества, на данный момент все лиды обрабатываются своевременно.
            </p>
          </Card>
        </Section>
