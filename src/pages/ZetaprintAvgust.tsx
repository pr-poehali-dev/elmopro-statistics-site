        ...
        <Section id="trends" num="04" title="Тренды с начала года" icon="ChartLine" sub="Проект в работе с января 2026 — динамика по месяцам">
          ...
          <div className="mt-6">
            <div className="mb-3 flex items-center gap-2 font-display text-lg font-semibold uppercase text-primary">
              <Icon name="Lightbulb" size={20} /> Выводы и стратегическая оценка маркетолога
            </div>
            <div className="grid gap-4 md:grid-cols-2">
              <Card className="border-primary/30">
                <div className="mb-2 flex items-center gap-2 font-display text-sm font-semibold uppercase text-primary">
                  <Icon name="Search" size={18} /> Поиск (Не бренд): тест новой стратегии и калибровка
                </div>
                <p className="text-sm leading-relaxed text-foreground/90">
                  В августе протестировали новую методику запуска поисковых кампаний: с переменным успехом
                  получали квалифицированные лиды по значительно меньшей стоимости. Однако такая стратегия
                  пока не позволяет быстро и стабильно масштабироваться на крупных бюджетах. Поэтому держим
                  её на умеренных лимитах и оптимизируем для прироста чистых и квалифицированных обращений
                  со снижением их себестоимости. Параллельно подключали новые кампании со свежими настройками
                  и перезапускали просевшие связки, удерживая плановые показатели.
                </p>
              </Card>

              <Card className="border-primary/30">
                <div className="mb-2 flex items-center gap-2 font-display text-sm font-semibold uppercase text-primary">
                  <Icon name="Layers" size={18} /> Игральные карты: удачный зацеп и специфика алгоритмов
                </div>
                <p className="text-sm leading-relaxed text-foreground/90">
                  По направлению карт одна из кампаний зацепилась за стабильную генерацию целевых лидов на
                  протяжении полумесяца. Это позволило сильно сбить стоимость квалифицированного лида
                  (<b>3 749 ₽</b>), нарастить объём и перевыполнить план с солидным запасом. Сейчас стараемся
                  воспроизвести этот результат. Но важно учитывать фактор автостратегий Яндекс Директа:
                  алгоритмы ведут себя непредсказуемо и напрямую не поддаются контролю кроме стандартных
                  настроек.
                </p>
              </Card>
              ...
              <Card className="border-primary/30">
                <div className="mb-2 flex items-center gap-2 font-display text-sm font-semibold uppercase text-primary">
                  <Icon name="Target" size={18} /> Бренд: точечный перехват горячего спроса
                </div>
                <p className="text-sm leading-relaxed text-foreground/90">
                  Брендовый трафик выделили в отдельную кампанию, чтобы отсечь лишние траты и не смешивать
                  статистику с общим поиском. Закрыли спецразмещение по минимальной стоимости (бюджет всего
                  <b> 10,3 тыс. руб.</b>, CPL <b>798 ₽</b>) и получили максимально дешёвые квалифицированные
                  обращения высокой степени готовности к заказу.
                </p>
              </Card>

              <Card className="border-primary/30">
                <div className="mb-2 flex items-center gap-2 font-display text-sm font-semibold uppercase text-primary">
                  <Icon name="TrendingUp" size={18} /> Сентябрь: рост на фоне осенней деловой активности
                </div>
                <p className="text-sm leading-relaxed text-foreground/90">
                  В полиграфии завершается летний спад и стартует традиционный сезонный подъём спроса. В
                  сентябре планируем конвертировать оживление рынка в больший объём квалифицированных лидов,
                  удерживая или дополнительно снижая их итоговую стоимость за счёт наработанных за август
                  связок.
                </p>
              </Card>
            </div>
