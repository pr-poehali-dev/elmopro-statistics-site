...
} from '@/data/report-art-dizo-sentyabr';
  ...
  return (
    <div ref={reportRef} className="min-h-screen bg-background text-foreground">
      ...
      <div className="container mx-auto space-y-16 px-6 py-12">
        ...
        {/* 2. ПЛАН / ФАКТ */}
        <Section id="planfact" num="02" title="Сравнение план / факт" icon="Target" sub="Динамика по ключевым показателям за сентябрь 2026">
          <Card>
        ...
        <Section id="trends" num="04" title="Тренды с начала работ" icon="ChartLine" sub="Проект в работе с июля 2026 — динамика по месяцам">
          <div className="grid gap-6 lg:grid-cols-2">
            <Card>
              ...
              <ResponsiveContainer width="100%" height={260}>
                <LineChart data={monthlyTrend} margin={{ top: 30 }}>
                  ...
                  <Line type="monotone" dataKey="cost" name="Бюджет" stroke={NEON.cyan} strokeWidth={2.5} dot={{ r: 5 }}>
            ...
            <Card>
              <ChartTitle title="Уникальные лиды, ед." sub="Июль — Сентябрь"
              ...
              <ResponsiveContainer width="100%" height={260}>
                <LineChart data={monthlyTrend} margin={{ top: 30 }}>
                  ...
                  <Line type="monotone" dataKey="leads" name="Уникальные лиды" stroke={NEON.violet} strokeWidth={2.5} dot={{ r: 5 }}>
            ...
            <Card>
              <ChartTitle title="Стоимость уникального лида, ₽" sub="Июль — Сентябрь"
              ...
              <ResponsiveContainer width="100%" height={260}>
                <LineChart data={monthlyTrend} margin={{ top: 30 }}>
                  ...
                  <YAxis stroke={axisColor} fontSize={11} />
                  <Tooltip contentStyle={tipStyle} formatter={(v: number) => `${fmt(v)} ₽`} />
                  <Line type="monotone" dataKey="cpl" name="Стоимость уник. лида" stroke={NEON.amber} strokeWidth={2.5} dot={{ r: 5 }}>
            ...
            <Card>
              <ChartTitle title="Чистые лиды, ед." sub="Июль — Сентябрь"
              ...
              <ResponsiveContainer width="100%" height={260}>
                <LineChart data={monthlyTrend} margin={{ top: 30 }}>
                  ...
                  <YAxis stroke={axisColor} fontSize={11} />
                  <Tooltip contentStyle={tipStyle} />
                  <Line type="monotone" dataKey="clean" name="Чистые лиды" stroke={NEON.lime} strokeWidth={2.5} dot={{ r: 5 }}>
            ...
            <Card>
              <ChartTitle title="Стоимость чистого лида, ₽" sub="Июль — Сентябрь"
              ...
              <ResponsiveContainer width="100%" height={260}>
                <LineChart data={monthlyTrend} margin={{ top: 30 }}>
                  ...
                  <YAxis stroke={axisColor} fontSize={11} />
                  <Tooltip contentStyle={tipStyle} formatter={(v: number) => `${fmt(v)} ₽`} />
                  <Line type="monotone" dataKey="ccpl" name="Стоимость чист. лида" stroke={NEON.violet} strokeWidth={2.5} dot={{ r: 5 }}>
            ...
            <Card>
              <ChartTitle title="Квалифицированные лиды, ед." sub="Июль — Август"
              ...
              <ResponsiveContainer width="100%" height={260}>
                <LineChart data={monthlyTrend} margin={{ top: 30 }}>
                  ...
                  <YAxis stroke={axisColor} fontSize={11} />
                  <Tooltip contentStyle={tipStyle} />
                  <Line type="monotone" dataKey="qual" name="Квал. лиды" stroke={NEON.amber} strokeWidth={2.5} dot={{ r: 5 }}>
            ...
            <Card>
              <ChartTitle title="Стоимость квалифицированных лидов, ₽" sub="Июль — Август"
              ...
              <ResponsiveContainer width="100%" height={260}>
                <LineChart data={monthlyTrend} margin={{ top: 30 }}>
                  ...
                  <YAxis stroke={axisColor} fontSize={11} />
                  <Tooltip contentStyle={tipStyle} formatter={(v: number) => `${fmt(v)} ₽`} />
                  <Line type="monotone" dataKey="qcpl" name="Стоимость квал. лида" stroke={NEON.neg} strokeWidth={2.5} dot={{ r: 5 }}>
          ...
          <Card className="mt-6 border-primary/30">
            ...
            <p className="text-sm leading-relaxed text-foreground/90">
              Сентябрь показывает уверенное продолжение положительной динамики, заложенной в августе.
              За август было получено <b>112 чистых лидов</b> по <b>1 154 ₽</b> и <b>73 квалифицированных
              лида</b> по <b>1 771 ₽</b> — рекордный результат с начала работы над проектом. В сентябре
              (на 20.09.2026) при бюджете всего <b>32 409 ₽</b> уже получено <b>49 чистых заявок</b> по
              цене <b>661 ₽</b> — это ниже плановой стоимости заявки почти вдвое, а доля чистых заявок
              составила <b>100%</b>, что заметно превышает плановые 85%. Такая динамика говорит о высоком
              качестве настроенных рекламных связок: даже при сокращённом бюджете кампании продолжают
              стабильно приносить недорогие целевые обращения. Месяц ещё не завершён, но текущие темпы
              позволяют рассчитывать на выполнение плана с хорошим запасом.
            </p>
          </Card>
        </Section>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card>
              ...
              {workPlan.length > 0 ? (
                ...
                <p className="text-sm text-muted-foreground">Планы будут сформированы позже.</p>
              )}
            </Card>
          </div>
        </Section>
        ...
        {/* 6. ПЛАН МЕСЯЦА */}
        <Section id="nextplan" num="06" title="План на новый месяц" icon="Flag" sub="Плановые показатели на октябрь 2026">
          <Card>
            <div className="overflow-x-auto">
...
export default ArtDizoSentyabr;