...
const VikupMskAvgust = () => {
  ...
  const [segNextPlan, setSegNextPlan] = useState<SegmentKey>('msk1');
        ...
        <Section id="trends" num="04" title="Тренды с начала работ" icon="ChartLine" sub="Проект в работе с июля 2026 — динамика по месяцам">
          ...
          <Card className="mt-6 border-primary/30">
            ...
            <p className="text-sm leading-relaxed text-foreground/90">
              Август показал уверенный рост по всем трём направлениям одновременно. В <b>МСК1</b> количество заявок
              выросло с 209 до <b>263</b>, а стоимость заявки снизилась с 1 436 ₽ до <b>1 184 ₽</b> — лучший результат
              среди сегментов. <b>МСК2</b> отличился ростом доли чистых заявок до <b>93,61%</b> при снижении спама
              почти вдвое (с 17 до 14 обращений), а продажи выросли с 12 до <b>14 выкупов</b> — максимум по проекту.
              В <b>МСК3</b> заявки увеличились с 125 до <b>206</b>, стоимость заявки упала с 2 129 ₽ до <b>1 488 ₽</b>,
              а доля чистых заявок выросла до 80,58%. Совокупно все три направления показали снижение стоимости
              заявки при росте объёма — рекламные кампании работают эффективнее, что даёт хорошую базу для
              дальнейшего масштабирования бюджета в сентябре.
            </p>
          </Card>
        </Section>
        ...
        <Section id="demand" num="06" title="Спрос" icon="Search" sub="Число запросов по Wordstat: 2024 / 2025 / 2026">
          <Card>
            ...
            <p className="mt-4 text-sm leading-relaxed text-foreground/90">
              Спрос по направлению сезонный: пиковые значения традиционно приходятся на конец года — декабрь 2024
              показал максимум в 44 132 запроса, декабрь 2025 — 16 645. В 2026 году спрос держится ниже уровня
              прошлых лет, но летние месяцы (июнь-август) прошли стабильно, без резких провалов — это говорит
              о сохраняющемся интересе аудитории даже вне сезонного пика. Осенний рост спроса традиционно
              начинается в сентябре-октябре, поэтому увеличение рекламной активности в этот период оправдано.
            </p>
          </Card>
        </Section>
