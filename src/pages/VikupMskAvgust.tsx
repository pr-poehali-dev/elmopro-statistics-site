      ...
      <div className="container mx-auto space-y-16 px-6 py-12">
        ...
        <Section id="trends" num="04" title="Тренды с начала года" icon="ChartLine" sub="Динамика по месяцам с января 2026 года">
          ...
          <Card className="mt-6 border-primary/30">
            ...
            <p className="text-sm leading-relaxed text-foreground/90">Август показал уверенный рост по всем трём направлениям одновременно. В МСК1 количество заявок выросло с 209 до 263, а стоимость заявки снизилась с 1 436 ₽ до 1 184 ₽ — лучший результат среди сегментов. МСК2 отличился ростом доли чистых заявок до 93,61% при снижении спама (с 17 до 14 обращений), а продажи выросли с 12 до 14 выкупов — максимум по проектам. В МСК3 заявки увеличились с 125 до 206, стоимость заявки упала с 2 129 ₽ до 1 488 ₽, а доля чистых заявок выросла до 80,58%. Совокупно все три направления показали снижение стоимости заявки при росте объёма — рекламные кампании работают эффективнее, что даёт хорошую базу для дальнейшей оптимизации кампаний в сентябре.</p>
          </Card>
        </Section>
