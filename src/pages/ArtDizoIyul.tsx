  ...
  return (
    <div ref={reportRef} className="min-h-screen bg-background text-foreground">
      ...
      <div className="container mx-auto space-y-16 px-6 py-12">
        ...
        {/* 2. ПЛАН / ФАКТ */}
        <Section id="planfact" num="02" title="Сравнение план / факт" icon="Target" sub="Динамика по ключевым показателям за июль 2026">
          <Card>
        ...
        <Section id="trends" num="04" title="Тренды с начала работ" icon="ChartLine" sub="Проект в работе с июля 2026 — динамика по месяцам">
          <div className="grid gap-6 lg:grid-cols-2">
            <Card>
              <ChartTitle title="Рекламный бюджет, ₽" sub="Июль"
            ...
            <Card>
              <ChartTitle title="Уникальные лиды, ед." sub="Июль"
            ...
            <Card>
              <ChartTitle title="Чистые лиды, ед." sub="Июль"
            ...
            <Card>
              <ChartTitle title="Квалифицированные лиды, ед." sub="Июль"
          ...
          <Card className="mt-6 border-primary/30">
            ...
            <p className="text-sm leading-relaxed text-foreground/90">
              В этот отчётный период мы с нуля собирали статистику, запустили рекламные связки. Как правило,
              в первый месяц проводится большая аналитическая работа, чтобы в последующие месяцы масштабировать
              наиболее эффективные связки и отключить то, что не приносит нам нужные результаты.
              Несмотря на это, нам удалось перевыполнить план по уникальным лидам и квалифицированным лидам —
              при стоимости ниже плановой.
            </p>
          </Card>
        </Section>
        ...
        {/* 6. ПЛАН МЕСЯЦА */}
        <Section id="nextplan" num="06" title="План на новый месяц" icon="Flag" sub="Плановые показатели на август 2026">
          <Card>
            <div className="overflow-x-auto">
        ...
        <footer className="border-t border-border pt-6 text-center font-mono text-xs text-muted-foreground">
          {CLIENT.name} · {CLIENT.id} · Отчёт по всем кампаниям Яндекс Директ · Июль 2026
        </footer>
      </div>
    </div>
  );
